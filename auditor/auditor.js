...
// // Function to fetch and display the document
// function fetchAndDisplayDocument() {
//     const documentName = "your_document_name"; // Replace with the name of your uploaded document

//     // Get the download URL for the document
//     storageRef.child(documentName).getDownloadURL()
//         .then(url => {
//             // Display the document using the URL
...
// // Call the function to fetch and display the document
